...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aF, request.L, true);
		} catch (e) {
...
var $author$project$Main$Model = F3(
	function (key, url, quotes) {
		return {W: key, E: quotes, L: url};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{au: false, aw: r.aw, aA: r.aA, T: r.T, aF: r.aF, aQ: r.aQ, ao: r.ao, L: r.L}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aw: $elm$http$Http$emptyBody, aA: r.aA, T: _List_Nil, aF: 'GET', aQ: $elm$core$Maybe$Nothing, ao: $elm$core$Maybe$Nothing, L: r.L});
};
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$Quote = F2(
	function (text, author) {
		return {N: author, an: text};
	});
...
var $author$project$Main$getQuotes = $elm$http$Http$get(
	{
		aA: A2($elm$http$Http$expectJson, $author$project$Main$GotQuotes, $author$project$Main$quotesDecoder),
		L: 'https://raw.githubusercontent.com/dwyl/quotes/master/quotes.json'
	});
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return _Utils_Tuple2(
			A3($author$project$Main$Model, key, url, _List_Nil),
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{aE: $author$project$Main$init, aH: $author$project$Main$UrlChanged, aI: $author$project$Main$LinkClicked, aP: $author$project$Main$subscriptions, aS: $author$project$Main$update, aT: $author$project$Main$view});
